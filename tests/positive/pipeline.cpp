...
TEST_F(VkPositiveLayerTest, TestShaderInputOutputMatch) {
    ...
    const char vsSource[] = R"glsl(#version 450
        ...
        layout(location = 0) out mat4 out0;
    ...
    vertex_input_attribute_descriptions[1].format = VK_FORMAT_R8G8B8_UNORM;
    vertex_input_attribute_descriptions[1].offset = 32;
    vertex_input_attribute_descriptions[2].location = 2;
    vertex_input_attribute_descriptions[2].binding = 0;
    vertex_input_attribute_descriptions[2].format = VK_FORMAT_R8G8B8_UNORM;
    ...
    vertex_input_attribute_descriptions[3].format = VK_FORMAT_R8G8B8_UNORM;
